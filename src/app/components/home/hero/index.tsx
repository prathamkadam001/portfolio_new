...
function HeroSection() {
  return (
    <section className="relative isolate min-h-[92vh] overflow-hidden bg-[#f7fbff] pt-[7rem] text-slate-950 dark:bg-[#06101f] dark:text-white md:pt-[8rem]">
      ...
      <div className="container relative z-10 grid min-h-[calc(92vh-8rem)] items-center gap-8 pb-12 lg:grid-cols-[1.02fr_0.98fr] lg:gap-10 lg:pb-16">
        <div className="max-w-4xl">
          ...
          <h1 className="hero-entrance hero-entrance-delay-1 mt-6 max-w-4xl text-4xl font-semibold leading-none tracking-normal text-slate-950 dark:text-white sm:text-5xl xl:text-6xl">
            Business website developer in Ahmedabad for websites that bring
            enquiries.
          </h1>

          <p className="hero-entrance hero-entrance-delay-2 mt-6 max-w-2xl text-base leading-7 text-slate-700 dark:text-slate-300 md:text-lg md:leading-8">
